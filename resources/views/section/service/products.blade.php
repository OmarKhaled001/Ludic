<section class="tc-latest-cases-style1">
    <div class="container">
        <div class="content">
            <h3 class="fsz-45 text-capitalize mb-90 js-splittext-lines" style="perspective: 400px;"><div style="display: block; text-align: start; position: relative; translate: none; rotate: none; scale: none; transform-origin: 620px 27px; transform: translate3d(0px, 0px, 0px); opacity: 1;"> Latest Cases </div></h3>
            <div class="cases">
                    ...
                    <div class="row mixitup" id="MixItUp921277"><div class="col-lg-4 mix-item Architecture Landscape">
                            <div class="case-card">
                                ...
                                <div class="info">
                                    ...
                                    <h3 class="title fsz-35 mb-20"> <a href="#" class="hover-orange1">
                                            Gordon’s Villa </a> </h3>
                                    <div class="text color-666"> This area will is short description of
                                        project, you can <br> select to show or hide it </div>
                                </div>
                            </div>
                            ...
                            <div class="case-card">
                                ...
                                <div class="info">
                                    ...
                                    <h3 class="title fsz-35 mb-20"> <a href="#" class="hover-orange1">
                                            Wasabi House </a> </h3>
                                    <div class="text color-666"> This area will is short description of
                                        project, you can <br> select to show or hide it, this a sample short
                                        <br> paragraph for this. </div>
                                </div>
                            </div>
                            ...
                            <div class="case-card">
                                ...
                                <div class="info">
                                    ...
                                    <h3 class="title fsz-35 mb-20"> <a href="#" class="hover-orange1">
                                            Dallas Homestay <br> Rennovation </a> </h3>
                                    <div class="text color-666"> This area will is short description of
                                        project, you can <br> select to show or hide it, this a sample short
                                        <br> paragraph for this. </div>
                                </div>
