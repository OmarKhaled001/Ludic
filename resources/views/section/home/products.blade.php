<section class="tc-team-style1">
    <div class="container">
        <div class="mb-80 js-splittext-lines text-center" style="perspective: 400px;"><div style="display: block; text-align: start; position: relative; translate: none; rotate: none; scale: none; transform-origin: 620px 27px; transform: translate3d(0px, 0px, 0px); opacity: 1;"><h2 class="fsz-45">Best Products</h2></div></div>
        <div class="members">
            <div class="row">
                <div class="col-lg-2">
                ...
                <div class="col-lg-2 order-last order-lg-0">
                    <div class="member-colmn">
                        ...
                        <a href="#" class="team-card team-text wow zoomIn" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: zoomIn;">
                            <div class="img" style="height: 181.656px;">
                                <h5 class="title"> <div class="con"> <span> See All Our <br> Products </span> <span class="arrow"> <i class="ti-arrow-top-right"></i> </span> </div> </h5>
                            </div>
                        </a>
                    </div>
                </div>
